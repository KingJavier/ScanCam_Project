...
const FotoTempSalScheme = new mongoose.Schema(
...
FotoTempSalScheme.plugin(mongooseDelete,{ overrideMeethods:"all"});

//! exportamos modelo de mongoose y enviamos el modelo a la DB
module.exports = mongoose.model('fototempsal', FotoTempSalScheme)