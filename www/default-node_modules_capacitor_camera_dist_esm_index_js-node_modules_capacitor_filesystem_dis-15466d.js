"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-node_modules_capacitor_camera_dist_esm_index_js-node_modules_capacitor_filesystem_dis-15466d"],{
  ...
  const defaultRegisterPlugin = (pluginName, jsImplementations = {}) => {
    ...
    const createPluginMethodWrapper = prop => {
      ...
      const wrapper = (...args) => {
        ...
        if (prop === 'addListener') {
          p.remove = /*#__PURE__*/(0,C_Users_reyca_Escritorio_Actualmente_scan_cam_front_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            return remove();
          });
        }
    ...
    const addListenerNative = (eventName, callback) => {
      ...
      const remove = /*#__PURE__*/function () {
        var _ref3 = (0,C_Users_reyca_Escritorio_Actualmente_scan_cam_front_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
class WebPlugin {
  ...
  addListener(eventName, listenerFunc) {
    ...
    const remove = /*#__PURE__*/function () {
      var _ref5 = (0,C_Users_reyca_Escritorio_Actualmente_scan_cam_front_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    Object.defineProperty(p, 'remove', {
      value: function () {
        var _ref6 = (0,C_Users_reyca_Escritorio_Actualmente_scan_cam_front_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          console.warn(`Using addListener() without 'await' is deprecated.`);
          yield remove();
        });
...
//# sourceMappingURL=default-node_modules_capacitor_camera_dist_esm_index_js-node_modules_capacitor_filesystem_dis-15466d.js.map