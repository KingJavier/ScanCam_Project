...
let ListadoseguridadPage = class ListadoseguridadPage {
    ...
    next() {
        ...
        console.log(num);
        const token = localStorage.getItem('token');
        this.resentrada.next(token, num).subscribe((res) => {
            console.log(res);
        });
    }
    back() {
        ...
        console.log(num);
        const token = localStorage.getItem('token');
        this.resentrada.back(token, num).subscribe((res) => {
            console.log(res);
        });
    }
    salir() {
    ...
    formatDate(value) {
        const token = localStorage.getItem('token');
        const da = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(value), 'yyyy-MM-dd');
        // console.log('data', da);
        this.usuarioServicio.filtro(token, da).subscribe((res) => {
            this.entrada = 0;
            this.entrada = res.guenas;
            // console.log(res.guenas);
        });
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(value), 'MMMM dd yyyy');
    }
    isDateEnabled(dateIsoString) {
        const date = new Date(dateIsoString);
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date) === 1 && (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(date) === 0 && (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(date) === 2022) {
...
ListadoseguridadPage.propDecorators = {
    datetime: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_10__.ViewChild, args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_11__.IonDatetime, { static: true },] }]
};
ListadoseguridadPage = (0,tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([
...
module.exports = ".salida {\n  font-size: 40px;\n  background-color: transparent;\n}\n\n.elicono {\n  font-size: 130px;\n}\n\n.lafoto {\n  max-width: 125px;\n  height: 125px;\n  padding: 0.5em;\n  height: 8vh;\n  filter: drop-shadow(3px 4px 4px #444);\n}\n\n.table {\n  width: 100%;\n  text-align: center;\n}\n\n.lacard {\n  border-radius: 1rem;\n  box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.537);\n  margin-top: 50px;\n}\n\n.titulos {\n  font-size: 35px;\n  font-family: \"Nanum Gothic\", sans-serif;\n}\n\n#colorletra {\n  color: black;\n}\n\n#feo {\n  overflow-x: scroll;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
