...
@Component({
  ...
  templateUrl: './perfilfuncionario.page.html',
  styleUrls: ['./perfilfuncionario.page.scss'],
})
export class PerfilfuncionarioPage implements OnInit {
  ...
  private socket: Socket,private router: Router, private usuarioServicio: TaskService) {
